...
<div class="container py-5" style="display: flex;">
    <div class="row">
        <!-- Hình ảnh sản phẩm -->
        <div class="col-md-6">
            <!-- <img src="images/laptop.jpg" class="img-fluid mb-3" alt="Laptop" id="main-img"> -->

            <div class="row g-2">
                    <div class="col-12">
                        <img src="<?= $baseURL . "Assets/uploads/img/". $product['Image']?>" class="img-fluid thumbnail-img" alt="Ảnh mô tả">
                    </div>
            </div>
        </div>
