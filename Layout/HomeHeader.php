...
<<<<<<< HEAD
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand fw-bold" href="<?=$baseURL?>Product/index" style="font-size: 1.8rem;">ShoppingQST</a>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand fw-bold" href="<?= $baseURL ?>Product/index" style="font-size: 1.8rem;">ShopQST</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?= $baseURL . 'Product/index' ?>">Shop it</a></li>
